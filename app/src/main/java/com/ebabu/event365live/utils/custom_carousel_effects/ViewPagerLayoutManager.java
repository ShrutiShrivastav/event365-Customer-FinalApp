...
public abstract class ViewPagerLayoutManager  extends LinearLayoutManager {
     ...
     *  method.
     */
    protected com.ebabu.event365live.utils.custom_carousel_effects.OrientationHelper mOrientationHelper;
    ...
    void ensureLayoutState() {
        if (mOrientationHelper == null) {
            mOrientationHelper = com.ebabu.event365live.utils.custom_carousel_effects.OrientationHelper.createOrientationHelper(this, mOrientation);
        }
    }
