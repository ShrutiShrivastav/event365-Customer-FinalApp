...
public class AndroidSpringLooperFactory {
    ...
    public static SpringLooper createSpringLooper() {
        return (SpringLooper)(Build.VERSION.SDK_INT >= 16 ? AndroidSpringLooperFactory.ChoreographerAndroidSpringLooper.create() : AndroidSpringLooperFactory.LegacyAndroidSpringLooper.create());
    }
    ...
    private static class ChoreographerAndroidSpringLooper extends SpringLooper {
        ...
        public static AndroidSpringLooperFactory.ChoreographerAndroidSpringLooper create() {
            return new AndroidSpringLooperFactory.ChoreographerAndroidSpringLooper(Choreographer.getInstance());
        }
    ...
    private static class LegacyAndroidSpringLooper extends SpringLooper {
        ...
        public static SpringLooper create() {
            return new AndroidSpringLooperFactory.LegacyAndroidSpringLooper(new Handler());
        }
