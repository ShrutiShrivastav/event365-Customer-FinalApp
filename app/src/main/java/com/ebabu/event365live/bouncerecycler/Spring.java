...
public class Spring {
    ...
    private final Spring.PhysicsState mCurrentState = new Spring.PhysicsState();
    private final Spring.PhysicsState mPreviousState = new Spring.PhysicsState();
    private final Spring.PhysicsState mTempState = new Spring.PhysicsState();
    ...
    private double getDisplacementDistanceForState(Spring.PhysicsState state) {
